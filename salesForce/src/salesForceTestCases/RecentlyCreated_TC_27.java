...
public class RecentlyCreated_TC_27 {

	public static void main(String[] args) throws InterruptedException {
		System.out.println("Recently Created ");
		...
		Select RecentlyCreatedDropdown =new Select(RecentlyCreated);
		RecentlyCreatedDropdown.selectByVisibleText("Recently Created");
		Thread.sleep(4000);
		
		System.out.println("Recently Created contacts are displayed");
